...
def remove_column(gray_image, column_path):
    ...
    for i in range(0, row_num):
        ...
        result[i, :col_index] = gray_image[i, :col_index]
        result[i, col_index:] = gray_image[i, col_index+1:]
    return result
...
def remove_row(gray_image, row_path):
    ...
    for j in range(0, col_num):
        ...
        result[:row_index, j] = gray_image[:row_index, j]
        result[row_index:, j] = gray_image[row_index+1:, j]
    return result
